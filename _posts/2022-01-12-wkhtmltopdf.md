...
layout: post
title:  "wkhtmltopdf参数"
date:   2022-01-12 21:12:05
categories: 
tags:  PDF
excerpt: wkhtmltopdf参数。
---



wkhtmltopdf是一个PDF输出工具，可以用来输出漂亮的PDF文件。
...
### 在VNote中用来输出PDF：
```powershell
--header-right "[date]" --header-font-name "微软雅黑" --header-font-size 8 --header-line --footer-line --header-left "《xxxxxx手册》" 
```
